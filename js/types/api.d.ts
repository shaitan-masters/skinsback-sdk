...
export declare type GameTypes = 'csgo' | 'dota2';
export declare type ResponseStatusType = 'success' | 'error';
export declare type OrderStatusType = 'pending' | 'fail' | 'success';
export declare type ReasonStatusServerType = 'site_off' | 'no_bots';
export declare type OfferStatusType = 'creating_trade' | 'waiting_accept' | 'accepted' | 'canceled' | 'timeout' | 'invalid_trade_token' | 'user_not_tradable' | 'trade_create_error';
